...
#define PA_LUSERS		1
#define PA_STATS		2
#define PA_USERHOST		3

#define PA_TYPE			3	/* mask for type bits */
#define PA_END			4	/* mask for `end' bit */

/* DCC Crap: */

#define DCC_CHAT		0x0001
#define DCC_TELNET		0x0002
#define DCC_SEND		0x0004
#define DCC_RECV		0x0008
...
#define UPTIME_EGGDROP		2	/* for use by eggdrops */
#define UPTIME_MINIMECH		3
#define UPTIME_WINMECH		4

#define UPTIME_HAL9000		7
#define UPTIME_ANABOT		8
#define UPTIME_FIRECLAW		10
#define UPTIME_GARNAX		11
